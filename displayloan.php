...
<?php
  echo "<body background='./css/template4.jpg'></body>";
 $a = $_GET['acno'];
  ...
  elseif (isset($_SESSION['login_user2'])) 
  {
    echo "<a href='./index2.php'><button type='button' class='btn btn-danger'><span class='fa fa-home'></span>&nbsp;Home</button></a>";
                                  ...
                                  $sqlsb = "SELECT * FROM loan where acno = '$a' " ;
                 ...
                 echo "<footer style='align:center;margin-top:380px'><button type='button' onclick='window.print()' class='btn btn-primary' ><span class='glyphicon glyphicon-print'></span> Print </button>
                                </form>
                                 </footer></html>";   
 ?>