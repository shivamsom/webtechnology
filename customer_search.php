...
<center><h1 class="text-info"><b>Search Customer Record</b></h1></center>	
<div class="container-fluid">
	<div class="row">
		...
		<div class="panel panel-primary thumbnail" id="emp"> 
				...
				<input type="text" name="lname" placeholder="LAST NAME" class="form-control cust_name" onkeyup="mobiledisable()">
					
				<input type="text" name="fname" placeholder="FIRST NAME" class="form-control cust_name" onkeyup="mobiledisable()">
					
				<input type="text" name="mname" placeholder="MIDDLE NAME" class="form-control cust_name" onkeyup="mobiledisable()">
