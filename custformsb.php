...
<script type="text/javascript" src="./js/preview.js"></script> <!--photo preview -->
       <form action="savings.php" method="post" enctype="multipart/form-data">
 <img  alt="upload_image click on choose file " id="passport" style="width:128px;height: 128px;float:right">
